...
def calculate_loss(proto_features, pooled, out, ys1, align_pf_weight, t_weight, unif_weight, cl_weight, 
    ...
    if is_count_pipnet:
        ...
        # pooled1 refers to the activations corresponding to the first augmented input (xs1)
        rounded_counts_1 = net.module.ste_round(pooled1) 
        # pooled2 refers to the activations corresponding to the second augmented input (xs2)
        ...
        normalized_counts_1 = clamped_counts_1 / C # Normalize with C hyperparameter
        normalized_counts_2 = clamped_counts_2 / C
